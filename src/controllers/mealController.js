...
// @access  Public
export const getMealCategories = async (_req, res, next) => {
  try {
...
export const createMealCategory = async (req, res, next) => {
  try {
...
// @access  Private (Admin)
export const updateMealCategory = async (req, res, next) => {
  try {
...
// @access  Private (Admin)
export const deleteMealCategory = async (req, res, next) => {
  try {
    const category = await MealCategory.findById(req.params.id);
    if (!category) {
      return res.status(404).json({ message: 'Meal category not found' });
...
// @access  Public
export const getMealAvailability = async (req, res, next) => {
  try {
...
// @access  Private (Owner/Admin)
export const updateMealAvailability = async (req, res, next) => {
  try {
    const meal = await Meal.findById(req.params.id).populate('vendor');
    if (!meal) {
      return res.status(404).json({ message: 'Meal not found' });
...
// @access  Private (Owner/Admin)
export const addMealImage = async (req, res, next) => {
  try {
    const meal = await Meal.findById(req.params.id).populate('vendor');
    if (!meal) {
      return res.status(404).json({ message: 'Meal not found' });
...
// @access  Public
export const getMealImages = async (req, res, next) => {
  try {
...
// @access  Private (Owner/Admin)
export const updateMealImage = async (req, res, next) => {
  try {
    const meal = await Meal.findById(req.params.id).populate('vendor');
    if (!meal) {
      return res.status(404).json({ message: 'Meal not found' });
...
// @access  Private (Owner/Admin)
export const deleteMealImage = async (req, res, next) => {
  try {
    const meal = await Meal.findById(req.params.id).populate('vendor');
    if (!meal) {
      return res.status(404).json({ message: 'Meal not found' });
